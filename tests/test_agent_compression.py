...
def _make_openai_response(content: str = "Done") -> MagicMock:
    msg = MagicMock()
    msg.content = content
    msg.tool_calls = None
    msg.model_extra = {}
...
def test_compression_tier1_triggered_at_threshold(
    ...
    with patch("nova.agent.microcompact_messages") as mock_compact:
        mock_compact.return_value = agent.messages[-12:]
...
def test_compression_disabled_in_config(minimal_config, mock_session_store, mock_openai_client):
